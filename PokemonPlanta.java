public class PokemonPlanta extends Pokemon{
    public PokemonPlanta(String nome, String classe, int indicePokedex, float altura, float peso, String regiao, int numeroEvolucoes){
    ...
    public void atacar(Pokemon alvo, int tipoAtaque) {
        ...
        switch (tipoAtaque) {
            case 1:
                ...
                System.out.println("chicote de vinha");
                if(testarFraqueza(3, alvo.getTipo())){
                    alvo.sofrerDano(dano * 2);
                }
                else if(testarResistencia(3, alvo.getTipo())){
